...
public class JWBF_Finish extends OpMode {
    ...
    private final Pose pickup4Pose = new Pose(17.58011049723757, 10, Math.toRadians(180)); //  try (8.2,24.4, 270 degreees)
    ...
    private final Pose intake4Pose = new Pose(12.596685082872927, 10, Math.toRadians(180)); //  try (8.2,8, 270 degreees)
    ...
    private final Pose Ctrl3 = new Pose(71.04972375690608, 30.70718232044198); // try (57.0671150612539, 29.87239971174633)
